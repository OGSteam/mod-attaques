...
$query = "SELECT users.name, users.id, " . "SUM(attacks.attack_metal), " . "(SELECT SUM(recy_metal) FROM " . TABLE_ATTAQUES_RECYCLAGES . " WHERE recy_user_id = users.id AND recy_date BETWEEN 1367359200 AND 1370037599) AS recy_metal, " . "SUM(attacks.attack_cristal), " . "(SELECT SUM(recy_cristal) FROM " . TABLE_ATTAQUES_RECYCLAGES . " WHERE recy_user_id = users.id AND recy_date BETWEEN 1367359200 AND 1370037599) AS recy_cristal, " . "SUM(attacks.attack_deut), SUM(attacks.attack_pertes) " . "FROM " . TABLE_USER . " users " . "INNER JOIN " . TABLE_ATTAQUES_ATTAQUES . " attacks ON attacks.attack_user_id = users.id " . "WHERE attacks.attack_date BETWEEN 1367359200 AND 1370037599 " . "GROUP BY users.id " . "ORDER BY users.name ASC";
