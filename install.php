...
$sqldata = json_encode(['transp' => 75, 'layer' => 1, 'defenseur' => 1, 'histo' => 1]);
mod_set_option('config', $sqldata);

// on insère les valeurs bbcodes par défaut
$sqldata = json_encode(['title' => '#FFA500', 'm_g' => '#00FF40', 'c_g' => '#00FF40', 'd_g' => '#00FF40', 'm_r' => '#00FF40', 'c_r' => '#00FF40', 'perte' => '#FF0000', 'renta' => '#00FF40']);
